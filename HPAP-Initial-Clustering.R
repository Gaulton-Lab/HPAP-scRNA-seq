###The following script will use Seurat to perform initial clustering of the data
...
for (sample in samples){
    wd <- sprintf('~/hpap/rna/%s/Upenn_scRNAseq/cellranger/%s/outs/raw_feature_bc_matrix/', samples, samples)
}
